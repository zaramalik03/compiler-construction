 ...
 */
 ...
 struct listnode {
     ...
     struct expression *count_expr1;  // Counting statement, start from expr1
     struct expression *count_expr2;  // Counting statement, to expr2
     struct listnode *counting_body; 
     int direction;                   // Upward or downward for counting statements
     int isArray; 
 };
