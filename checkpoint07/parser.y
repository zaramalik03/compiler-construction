 ...
 * Date----------April 14, 2025
 * This is the bison file that is enhanced to while statements, exit statements,
 * mods and arrays for a Slic file and builds an abstract syntax tree and GSTAL 
 * code generator when parsing. 
 *------------------------------------------------------------------------------
 */
...
%type <listpoint> assignment_statement print_statement read_statement if_statement if_else_statement exit_statement while_statement
